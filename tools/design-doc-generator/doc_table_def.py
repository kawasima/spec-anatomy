...
従来SIの設計をそのまま写す。申請のライフサイクルは appl_status(申請状態10コード)という
...
TABLES = [
    {
        ...
        "columns": [
            ...
            _col(7, "申請状態", "APPL_STATUS", "申請状態", "NCHAR", 2, default="00",
                 itemdef="申請状態(00:下書き / 10:申請済 / 20:事前承認待ち / 21:事前承認不要 / 30:事前承認済 / 31:事前承認却下 / 40:実績登録済 / 50:最終承認済 / 60:経理連携済 / 90:取消済)。コードC0030001を参照する。画面遷移・登録処理で本カラムを更新する。"),
