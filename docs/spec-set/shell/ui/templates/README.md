...
派生元のない項目が出てきたら、それは Core の `data` に追加すべき業務概念です。Shell に閉じた項目発明は、書籍8.1.3 で批判される画面駆動・配線プログラミングの再生産になります。
...
ただし次は Spec Set には含めません。書籍8.1.3 の批判に従い、コードと冗長な項目を文書から除外しています。
