...
イミュータブルデータモデル（書籍4章）を採用している場合は、UPDATE/DELETE をしないことを明記。
...
このテーブルが他のテーブルと関連を持つ場合は、書籍6.4 の4論点（パリティ・ID/実体・取得タイミング・更新方式）の組み合わせを明示します。
...
書籍7章・8.7 の流儀に従い、Expand and Contract で段階的に変更します。
